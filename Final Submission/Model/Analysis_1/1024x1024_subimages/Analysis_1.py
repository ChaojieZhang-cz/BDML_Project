...
train_df_path = '/scratch/cz2064/myjupyter/BDML/Project/Phase5/Train_Test_Split/train_layer2_subimages.csv'
val_df_path = '/scratch/cz2064/myjupyter/BDML/Project/Phase5/Train_Test_Split/val_layer2_subimages.csv'
test_df_path = '/scratch/cz2064/myjupyter/BDML/Project/Phase5/Train_Test_Split/test_layer2_subimages.csv'
...
def train(model, train_loader=train_loader, val_loader=val_loader, learning_rate=0.0001, num_epoch=1000):
