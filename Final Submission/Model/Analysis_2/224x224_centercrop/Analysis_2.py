...
class train_dataset(Dataset):
    ...
    def __getitem__(self,idx):
        imgage_folder = '/scratch/cz2064/myjupyter/BDML/Project/Data/data_subimages/'
...
train_df_path = '/scratch/cz2064/myjupyter/BDML/Project/Phase5/Train_Test_Split/train_subimages.csv'

train_sampler = torch.utils.data.sampler.RandomSampler(train_dataset(train_df_path),num_samples=20000,replacement=True)

train_loader = DataLoader(train_dataset(train_df_path), batch_size=BATCH_SIZE, sampler = train_sampler)
...
val_df_path = '/scratch/cz2064/myjupyter/BDML/Project/Phase5/Train_Test_Split/val_subimages.csv'

val_sampler = torch.utils.data.sampler.RandomSampler(val_dataset(val_df_path),num_samples=5000,replacement=True)

val_loader = DataLoader(val_dataset(val_df_path), batch_size=BATCH_SIZE, sampler = val_sampler)


test_df_path = '/scratch/cz2064/myjupyter/BDML/Project/Phase5/Train_Test_Split/test_subimages.csv'

test_loader = DataLoader(val_dataset(test_df_path), batch_size=BATCH_SIZE)
